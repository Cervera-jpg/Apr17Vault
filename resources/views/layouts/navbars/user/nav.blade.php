...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-2 px-4">
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark fs-6" href="javascript:;">USER</a></li>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-end" id="navbar"> 
            ...
            <li class="nav-item dropdown pe-2 d-flex align-items-center">
                <a href="{{ url('/user/view-requests') }}" class="nav-link text-body p-0 icon-link position-relative">
...
@keyframes pulse {
    0% {
        transform: scale(1);
        box-shadow: 0 0 0 0 rgba(130, 17, 49, 0.7);
    }
    
    70% {
        transform: scale(1.1);
        box-shadow: 0 0 0 10px rgba(130, 17, 49, 0);
    }
    
    100% {
        transform: scale(1);
        box-shadow: 0 0 0 0 rgba(130, 17, 49, 0);
    }
}
</style>
<!-- End Navbar -->